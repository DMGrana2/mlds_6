...
Se desarrolla una aplicación web interactiva que muestre un mapa de susceptibilidad de deslizamientos en el departamento de Caldas, generado a apartir de modelos de Machine Learning (ML) y  Redes Neuronales Convolucionales (CNN) entrenados con datos satelitales y geológicos abiertos.
